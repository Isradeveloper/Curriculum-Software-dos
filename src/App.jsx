      ...
      <div className='bg-white d-flex justify-content-center my-4 mx-10' id='header'>
        <div className="row w-100 d-flex justify-content-center">
          ...
          <div className="col-12 col-lg-9 d-flex flex-column p-4 justify-content-between">
            ...
            <div className="col-12 p-4 d-flex justify-content-start align-items-center" style={{height: "70px"}}>
              <FaLocationDot className='me-3 text-primary2' size={25}/> <span className='fw-bold'>Barranquilla, Colombia</span> <a className='mx-5' href="https://github.com/Isradeveloper" target='_blank'><BsGithub size={25} className='text-primary2'/></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='bg-white d-flex justify-content-center my-4 mx-10 flex-column' id='skills'>
        <div className="w-100 d-flex justify-content-start flex-column p-4">
          ...
          <div className="row d-flex wrap gx-1">
            <div className="col-12 col-lg-2 card d-flex flex-row align-items-center gap-4">
      ...
      <div className='bg-white d-flex justify-content-center my-4 mx-10 flex-column' id='skills'>
        <div className="w-100 d-flex justify-content-start flex-column p-4">
          ...
          <div className="col-12 d-flex flex-row">
            <div className="col-3 p-4 d-flex flex-column justify-content-center align-items-center">
              ...
              <span className='fs-5 text-primary'>INGENIERO DE DESARROLLO JR</span>
          ...
          <div className="col-12 d-flex flex-row">
            <div className="col-3 p-4 d-flex flex-column justify-content-center align-items-center">
              ...
              <span className='fs-5 text-primary'>DESARROLLADOR FULLSTACK</span>
